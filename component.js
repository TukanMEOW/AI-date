...
var DatingApp = () => {
  ...
  useEffect(() => {
    const initializeApp = async () => {
      ...
      console.log("\u{1F504} \u041E\u0436\u0438\u0434\u0430\u043D\u0438\u0435 \u0437\u0430\u0433\u0440\u0443\u0437\u043A\u0438 Telegram WebApp...");
      const tg = await waitForTelegram();
      if (tg) {
        console.log("\u2705 Telegram WebApp \u043D\u0430\u0439\u0434\u0435\u043D");
        console.log("\u{1F50D} \u041F\u043E\u043B\u043D\u0430\u044F \u043E\u0442\u043B\u0430\u0434\u043A\u0430 Telegram \u043E\u0431\u044A\u0435\u043A\u0442\u0430:");
        ...
        try {
          ...
          if (tg.initDataUnsafe?.user) {
            console.log("\u{1F389} \u0420\u0415\u0410\u041B\u042C\u041D\u042B\u0419 \u041F\u041E\u041B\u042C\u0417\u041E\u0412\u0410\u0422\u0415\u041B\u042C \u041D\u0410\u0419\u0414\u0415\u041D:");
            ...
            console.log("\u{1F50D} \u0412\u043E\u0437\u043C\u043E\u0436\u043D\u044B\u0435 \u043F\u0440\u0438\u0447\u0438\u043D\u044B:");
  ...
  const authenticateUser = async (tg) => {
    try {
      ...
      let initDataRaw = "";
      try {
        const { retrieveRawInitData } = await import("https://esm.sh/@telegram-apps/sdk?deps=react@18.2.0,react-dom@18.2.0");
        initDataRaw = retrieveRawInitData();
        console.log("\u{1F4F1} Raw init data \u043F\u043E\u043B\u0443\u0447\u0435\u043D\u044B \u0438\u0437 SDK");
      } catch (sdkError) {
      ...
      if (tg && tg.initDataUnsafe?.user) {
        console.log("\u{1F504} \u0418\u0441\u043F\u043E\u043B\u044C\u0437\u0443\u0435\u043C fallback \u0430\u0432\u0442\u043E\u0440\u0438\u0437\u0430\u0446\u0438\u044E \u0434\u043B\u044F \u0440\u0430\u0437\u0440\u0430\u0431\u043E\u0442\u043A\u0438");
        const fallbackUser = {
  ...
  const saveUserProfile = useCallback(async (profileData) => {
    try {
      console.log("\u{1F4BE} \u0421\u043E\u0445\u0440\u0430\u043D\u0435\u043D\u0438\u0435 \u043F\u0440\u043E\u0444\u0438\u043B\u044F \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F \u043D\u0430 \u0441\u0435\u0440\u0432\u0435\u0440\u0435...");
  ...
  const fetchMatches = useCallback(async () => {
    try {
      console.log("\u{1F50D} \u041F\u043E\u043B\u0443\u0447\u0435\u043D\u0438\u0435 \u0441\u043E\u0432\u043F\u0430\u0434\u0435\u043D\u0438\u0439 \u0441 \u0441\u0435\u0440\u0432\u0435\u0440\u0430...");
  ...
  const sendNotification = useCallback(async (recipientId, message) => {
    try {
      console.log("\u{1F4E4} \u041E\u0442\u043F\u0440\u0430\u0432\u043A\u0430 \u0443\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u044F \u0447\u0435\u0440\u0435\u0437 \u0441\u0435\u0440\u0432\u0435\u0440...");
      ...
      if (tg && tg.sendData) {
        ...
        console.log("\u{1F4F1} \u0423\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u0435 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u043E \u0447\u0435\u0440\u0435\u0437 Telegram WebApp API");
      }
    }
  ...
  useEffect(() => {
    console.log("\u{1F6A8} DEBUG - \u0421\u043E\u0441\u0442\u043E\u044F\u043D\u0438\u0435 \u043F\u043E\u043B\u043D\u043E\u044D\u043A\u0440\u0430\u043D\u043D\u043E\u0433\u043E \u043E\u043A\u043D\u0430 \u0438\u0437\u043C\u0435\u043D\u0438\u043B\u043E\u0441\u044C:", {
  ...
  useEffect(() => {
    console.log("\u{1F6A8} DEBUG - Matches \u0438\u0437\u043C\u0435\u043D\u0438\u043B\u0438\u0441\u044C:", matches);
  }, [matches]);
  useEffect(() => {
    console.log("\u{1F6A8} DEBUG - LikedProfiles \u0438\u0437\u043C\u0435\u043D\u0438\u043B\u0438\u0441\u044C:", likedProfiles);
  }, [likedProfiles]);
  const DiscoverView = () => {
    const profile = profiles[currentProfile];
